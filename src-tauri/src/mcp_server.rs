...
impl McpServer {
  ...
  /// Chokepoint for the future per-hour automation request limit.
  ...
  pub fn get_tools(&self) -> Vec<McpTool> {
    vec![
      ...
      McpTool {
        ...
        description: "Launch a browser profile with an optional URL. Free for all users.".to_string(),
        input_schema: serde_json::json!({
          "type": "object",
          "properties": {
            "profile_id": {
      ...
      McpTool {
        ...
        description: "Stop a running browser profile. Free for all users.".to_string(),
        input_schema: serde_json::json!({
          "type": "object",
          "properties": {
            "profile_id": {
      ...
      McpTool {
        ...
        description: "Launch multiple browser profiles at once with an optional URL. Free for all users.".to_string(),
        input_schema: serde_json::json!({
          "type": "object",
          "properties": {
            "profile_ids": {
      ...
      McpTool {
        ...
        description: "Stop multiple running browser profiles at once. Free for all users.".to_string(),
        input_schema: serde_json::json!({
          "type": "object",
          "properties": {
            "profile_ids": {
      ...
      McpTool {
        ...
        description:
          "Update the fingerprint configuration for a Wayfern or Camoufox profile. Free for all users."
            .to_string(),
        input_schema: serde_json::json!({
          "type": "object",
          "properties": {
      ...
      McpTool {
        ...
        description: "List all managed browser extensions. Free for all users.".to_string(),
        input_schema: serde_json::json!({
          "type": "object",
          "properties": {},
          "required": []
      ...
      McpTool {
        ...
        description: "List all extension groups. Free for all users.".to_string(),
        input_schema: serde_json::json!({
          "type": "object",
          "properties": {},
          "required": []
      ...
      McpTool {
        ...
        description: "Create a new extension group. Free for all users.".to_string(),
        input_schema: serde_json::json!({
          "type": "object",
          "properties": {
      ...
      McpTool {
        ...
        description: "Delete a managed extension. Free for all users.".to_string(),
        input_schema: serde_json::json!({
          "type": "object",
          "properties": {
      ...
      McpTool {
        ...
        description: "Delete an extension group. Free for all users.".to_string(),
        input_schema: serde_json::json!({
          "type": "object",
          "properties": {
      ...
      McpTool {
        ...
        description: "Assign an extension group to a profile, or remove the assignment. Free for all users.".to_string(),
        input_schema: serde_json::json!({
          "type": "object",
          "properties": {
      ...
      McpTool {
        ...
        description: "Start a synchronizer session. Launches a leader profile and follower profiles, then mirrors all actions from the leader to the followers in real time. Only Wayfern profiles are supported. Free for all users.".to_string(),
        input_schema: serde_json::json!({
          "type": "object",
          "properties": {
            "leader_profile_id": {
  ...
  async fn dispatch_tool_call(
    ...
    match tool_name {
      ...
      "update_profile_fingerprint" => {
        Self::require_capability("Fingerprint editing", true).await?;
